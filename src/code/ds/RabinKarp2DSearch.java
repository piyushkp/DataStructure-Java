...
111111
 */
public class RabinKarp2DSearch {
  ...
  /**
   * Powers of RADIX. Used to find the hash when the pattern window is shifted. Analogous to RM in
   * S&W's code.
   */
  ...
  public RabinKarp2DSearch(char[][] pattern) {
